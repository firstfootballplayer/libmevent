...
#include "libmevent/base/TimeZone.h"
...
libmevent::TimeZone::TimeZone(const char* zonefile) : data_(new TimeZone::Data)
{
...
libmevent::TimeZone::TimeZone(int eastOfUtc, const char* name) : data_(new TimeZone::Data)
{
