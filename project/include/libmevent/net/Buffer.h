...
#ifndef libmevent_NET_BUFFER_H
#define libmevent_NET_BUFFER_H
...
/// @endcode
class Buffer : public libmevent::copyable {
public:
  ...
  const char *findEOS() const {
    const void *eol = memchr(peek(), '\0', readableBytes() + 1);
    return static_cast<const char *>(eol);
  }
